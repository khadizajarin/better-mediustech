  ...
  return (
    <div className="bg-white p-8 text-gray-700">
      ...
      <div className="text-xs">
        ...
        <p>Texas Real Estate Commission: <a href="#">Information About Brokerage Services</a> | <a href="#">Consumer Protection Notice</a></p>
        <p>Better Settlement Services, LLC. 325-41 Chestnut Street, Suite 803, Philadelphia, PA 19106.</p>
        <p>Homeowners insurance policies are offered through Better Cover, LLC, a Pennsylvania Resident Producer Agency. License #881593. 325-41 Chestnut Street, Suite 807, Philadelphia, PA 19106. Here is a full listing of Better Cover, LLC’s <a href="#">license numbers</a>.</p>
        <p>Insurance quotes and policies are offered through Better Cover, LLC: A Pennsylvania Resident Producer Agency. License #881593. Here is a full listing of Better Cover, LLC’s <a href="#">license numbers</a>.</p>
